            ...
            <DialogContent className="max-h-[85vh] overflow-y-auto sm:max-w-lg">
              <DialogHeader>
                ...
                <DialogDescription>
                  ...
                  (Mock — wiring comes later.)
                </DialogDescription>
              </DialogHeader>
              <div className="flex flex-col gap-4 py-2">
                <div className="flex flex-col gap-2">
                  <Label>Campaign name</Label>
                  <Input placeholder="e.g. Columbus Home Services — July" />
                </div>
                <div className="flex flex-col gap-2">
                  <Label>Sequence</Label>
                  <Select defaultValue={sequences[0].id}>
                  ...
                  <Select defaultValue="filtered">
                    ...
                    <SelectContent>
                      <SelectItem value="filtered">
                        Current lead filter (18 leads)
                      </SelectItem>
                      <SelectItem value="new">New leads only</SelectItem>
                      <SelectItem value="enriched">Enriched leads only</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="flex flex-col gap-2">
                    ...
                    <Input type="time" defaultValue="09:00" className="font-mono" />
                  </div>
                  <div className="flex flex-col gap-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Sends are spaced with human-like delays inside the window and
                  stop automatically when a lead replies.
                </p>
              </div>
              <DialogFooter>
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="ml-auto flex gap-2">
                    ...
                    {campaign.status === "paused" && (
                      <Button size="sm" onClick={() => setStatus(campaign.id, "active")}>
